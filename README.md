...
Archive: [10.5281/zenodo.16929954](https://doi.org/10.5281/zenodo.16929954)

Artifact instructions [best viewed on Github](https://github.com/mmcloughlin/arrival-oopsla25-artifact/tree/v3).
...
```
cd /root/arrival/cranelift/isle/veri/isaspec
...
produced by the `eval.sh` script above. Specifically, we ran both a "full"
...
#### Optional: Validate Supplemental Data

The `/root/artifact/eval/data/` directory contains supplemental data files
...
[mmcloughlin/arrival](https://github.com/mmcloughlin/arrival/tree/oopsla25-artifact-v3).
...
* [Getting Started Guide](https://github.com/mmcloughlin/arrival/blob/oopsla25-artifact-v3/cranelift/isle/veri/README.md)
* [Specification Language Reference](https://github.com/mmcloughlin/arrival/blob/oopsla25-artifact-v3/cranelift/isle/veri/docs/language.md)
...
[cranelift/isle/veri/isaspec](https://github.com/mmcloughlin/arrival/tree/oopsla25-artifact-v3/cranelift/isle/veri/isaspec).
...
configuration](https://github.com/mmcloughlin/arrival/blob/oopsla25-artifact-v3/cranelift/isle/veri/isaspec/src/instructions.rs).
