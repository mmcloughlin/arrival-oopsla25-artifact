...
* `spec_lines.tsv`: generated by running `./script/spec_lines.sh` from `/root/arrival/cranelift/isle/veri/veri` directory.
* `generated_isle_files.txt`: generated by running `./script/generated_isle_files.sh` from the `/root/arrival/cranelift/isle/veri/veri` directory.
